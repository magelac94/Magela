...
public class AdaptadorInterfazManejadores implements IAdaptadorInterfazManejadores {
    ...
    public AdaptadorInterfazManejadores() {
    ...
    @Override
    public Lista<Pelicula> buscaMultiple(String nombreBuscar,short fechaShort2,float rankingB2,String generoBuscar){
       return manejadorPeliculas.buscaMultiple(nombreBuscar,fechaShort2,rankingB2,generoBuscar);
    }
    ...
    public Lista<Pelicula> buscarPorActorLista(String nombreActor, Lista<Pelicula> listaDondeBuscar) {
        ...
        return null; //peliculasEncontradas.getLista();
    }
