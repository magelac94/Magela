 ...
 * @author Josse
 */
public class InterfazPP extends javax.swing.JFrame {
    IAEDMovieAdapter aedMovieAdapter;
    /**
     * Creates new form AEDIMovieFrame
     */
    public InterfazPP() {
        aedMovieAdapter = new AdaptadorInterfaz();
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InterfazPP.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InterfazPP().setVisible(true);
            }
        });
    }
