...
public interface IElementoAB<T> {
	...
	/**
     * devuelve los niveles de las hojas de sus subárboles.
     * @param nivel para ir llevando el nivel en las llamadas recursivas
     * @return String con los niveles de las hojas separados por un guión
     */
	public String nivelDeHojas (int nivel); 
}
