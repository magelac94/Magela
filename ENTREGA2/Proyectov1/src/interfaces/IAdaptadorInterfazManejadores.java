...
public interface IAdaptadorInterfazManejadores {
    ...
    /**
     * 
     * @param nombreBuscar Nombre de la pelicula a buscar
     * @param fechaShort2 Fecha de la pelicula a buscar - fecha de a;o
     * @param rankingB2 Numero entero de ranking a buscar
     * @param generoBuscar Genero de la pelicula a buscar
     * @return 
     */
